...
- **主要原因**：**时代与行业的转型**——大模型与 Agent 应用进入可产品化阶段，我认为这是下一阶段值得投入的技术方向，因此主动系统学习与实践
- **个人选择**：这是我主动的职业方向调整，源于对 Agent 赛道的判断与兴趣
- **与过往能力的关系**：不是抛弃前端，而是在十余年工程化经验（多端、架构、SSE/流式、协作规范）之上，把能力延伸到 Agent 工程化
- **时间线**：2026 年 5 月离职后全职投入 Agent 学习与 Playground 实践；此前在职期间仍以小程序/前端架构为主
